...
public class JwtUtil {
    ...
    private Claims extractAllClaims(String token) {
        // Use parserBuilder and setSigningKey properly
        return Jwts.parserBuilder()
                .setSigningKey(key) // Correct way to set the signing key
                .build()
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .signWith(key, SignatureAlgorithm.HS256) // Ensure using the correct signing key object
                .compact();
    }
